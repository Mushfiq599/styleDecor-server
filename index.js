...
app.get("/seed", async (req, res) => {
  ...
  const seedServices = [
    ...
    { service_name: "Home Interior Decoration", cost: 5000, unit: "per room", service_category: "home", description: "Transform your living spaces with our expert interior decoration services tailored to your personal style and budget.", image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=500&q=80", createdByEmail: "admin@styledecor.com" },
    ...
    { service_name: "Mehndi & Haldi Décor", cost: 16000, unit: "per event", service_category: "wedding", description: "Colorful mehndi/haldi setups with traditional backdrops and seating.", image: "https://images.unsplash.com/photo-1602576666092-bf6447a729fc?w=500&q=80", createdByEmail: "admin@styledecor.com" },
    ...
    { service_name: "Coworking Space Decoration", cost: 9000, unit: "per floor", service_category: "office", description: "Modern coworking décor with zones for focus, collaboration and relaxation.", image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=500&q=80", createdByEmail: "admin@styledecor.com" },
